                    ...
                    <div class="row">      
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Title" name="subtitle" value="{{ old('subtitle') }}"/>
                            </div>
                            <div class="form-group">
                                <label>Content</label>
                                <textarea rows="8" class="form-control nicEdit" placeholder="content" name="content">{{ old('content') }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Button Text" name="button_text" value="{{ old('button_text') }}"/>
                            </div>
